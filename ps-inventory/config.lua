...
Config.MaxInventoryWeight = 50000 -- Max weight a player can carry (default 120kg, written in grams)
Config.MaxInventorySlots = 6 -- Max inventory slots for a player
